...
The MATLAB client for this example can then be generated by running the following in the `Software` directory:
...
Or by using the following commands inside MATLAB:
